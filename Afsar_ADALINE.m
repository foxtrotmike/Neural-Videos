...
% Modified by Fayyaz A. Afsar, DCIS, PIEAS
%%
...
clear
clc
disp('This code makes a NOT GATE and shows the corresponding error surface and corresponding steps towards optimization using Gradient Descent Approach')
disp('Press Any Key to continue')
P=[ 1 -1]; %DEVELOPMENT OF A NOT-GATE
T=[-1 1];
%%
...
w_range = -2:0.2:2;  b_range = -2:0.2:2;
